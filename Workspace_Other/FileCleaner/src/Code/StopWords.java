...
public class StopWords {
	...
	public StopWords(){
		try {
			...
			BufferedReader in = new BufferedReader(new FileReader("/Users/IrisSeaman/Documents/Research/Stemmer/src/ParseUnicorn/stopwords.txt")); //THIS IS THE FILE THAT CONTAINS THE STOPWORDS
